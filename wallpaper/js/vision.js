...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function vo(e,t,n){return new Ui({name:`SphericalGaussianBlur`,defines:{SAMPLES:no,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:xo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function yo(){return new Ui({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:xo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function bo(){return new Ui({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:xo(),fragmentShader:`
	...
	`}var So=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Oi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};El.BlurDirectionX=new W(1,0),El.BlurDirectionY=new W(0,1);var Dl=`// ─────────────────────────────────────────────────────────────────────────────
...
`,ql={uniforms:{tDiffuse:{value:null},uRes:{value:null},uCA:{value:0},uTime:{value:0},uExposure:{value:1},uGrain:{value:.006}},vertexShader:`
    varying vec2 vUv;
  ...
  `},Jl=class extends El{scale=1;setSize(e,t){super.setSize(Math.max(64,Math.round(e*this.scale)),Math.max(64,Math.round(t*this.scale)))}},Yl=class{renderer;scene=new In;camera;composer;bloom;final;canvas;gpuName;isWebGL2;dprCap=1.5;width=1;height=1;bgColor=new J;contextLost=!1;lastSceneCalls=0;lastSceneLines=0;lastScenePoints=0;lastSceneTriangles=0;lastTotalCalls=0;constructor(e,t,n){this.renderer=new ol({antialias:!1,alpha:!1,powerPreference:`high-performance`,stencil:!1,depth:!1,preserveDrawingBuffer:!1});let r=this.renderer.getContext();this.isWebGL2=typeof WebGL2RenderingContext<`u`&&r instanceof WebGL2RenderingContext;let i=r.getExtension(`WEBGL_debug_renderer_info`);this.gpuName=i?String(r.getParameter(i.UNMASKED_RENDERER_WEBGL)):`unknown`,this.renderer.toneMapping=0,this.renderer.info.autoReset=!1,this.canvas=this.renderer.domElement,this.canvas.id=`orb-canvas`,e.appendChild(this.canvas),this.camera=new ya(42,1,.1,100),this.camera.position.copy(ml),this.buildComposer(),this.canvas.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),this.contextLost=!0,t()}),this.canvas.addEventListener(`webglcontextrestored`,()=>{this.contextLost=!1,this.buildComposer(),this.resize(),n()})}buildComposer(){let e=this.bloom?{strength:this.bloom.strength,scale:this.bloom.scale,ca:this.final.uniforms.uCA.value}:null;this.composer=new Cl(this.renderer),this.composer.addPass(new wl(this.scene,this.camera)),this.bloom=new Jl(new W(256,256),.85,.35,.42),this.composer.addPass(this.bloom);let t={...ql,uniforms:Bi.clone(ql.uniforms)};t.uniforms.uRes.value=new W(1,1),this.final=new bl(t),this.composer.addPass(this.final),e&&(this.bloom.strength=e.strength,this.bloom.scale=e.scale,this.final.uniforms.uCA.value=e.ca)}setBackground(e){this.bgColor.set(e),this.renderer.setClearColor(this.bgColor,1)}setDprCap(e){this.dprCap=Math.min(1.5,e),this.resize()}get dpr(){return Math.min(window.devicePixelRatio||1,this.dprCap)}setBloom(e,t){this.bloom.strength=e,this.bloom.scale!==t&&(this.bloom.scale=t,this.resize())}setChromatic(e){this.final.uniforms.uCA.value=e?.012:0}resize(){this.width=Math.max(1,window.innerWidth),this.height=Math.max(1,window.innerHeight);let e=this.dpr;this.renderer.setPixelRatio(e),this.renderer.setSize(this.width,this.height),this.composer.setPixelRatio(e),this.composer.setSize(this.width,this.height),this.camera.aspect=this.width/this.height,this.camera.fov=this.camera.aspect<1?42/Math.max(.6,this.camera.aspect):42,this.camera.setViewOffset(this.width,this.height,0,Math.round(this.height*.035),this.width,this.height),this.camera.updateProjectionMatrix(),this.final.uniforms.uRes.value.set(this.width*e,this.height*e)}get bufferHeight(){return this.height*this.dpr}render(e){if(this.contextLost)return;this.final.uniforms.uTime.value=e;let t=this.renderer.info;t.reset(),this.composer.render(),this.lastTotalCalls=t.render.calls}sampleSceneStats(){let e=this.renderer.info,t=this.composer.readBuffer;e.reset(),this.renderer.setRenderTarget(t),this.renderer.render(this.scene,this.camera),this.renderer.setRenderTarget(null),this.lastSceneCalls=e.render.calls,this.lastSceneLines=e.render.lines,this.lastScenePoints=e.render.points,this.lastSceneTriangles=e.render.triangles}dispose(){this.composer.dispose(),this.renderer.dispose(),this.canvas.remove()}};function Xl(e){let t=e>>>0;return()=>{t=t+1831565813>>>0;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}function Zl(e){let t=0;for(;t===0;)t=e();return Math.sqrt(-2*Math.log(t))*Math.cos(2*Math.PI*e())}function Ql(e,t){let n=e()*2-1,r=e()*Math.PI*2,i=Math.sqrt(1-n*n);t[0]=i*Math.cos(r),t[1]=i*Math.sin(r),t[2]=n}function $l(e){let t=Xl(e),n=new Uint8Array(512),r=new Float32Array(256);for(let e=0;e<256;e++)n[e]=e,r[e]=t()*2-1;for(let e=255;e>0;e--){let r=Math.floor(t()*(e+1)),i=n[e];n[e]=n[r],n[r]=i}for(let e=0;e<256;e++)n[e+256]=n[e];let i=e=>e*e*(3-2*e),a=(e,t,i)=>r[n[n[n[e&255]+(t&255)]+(i&255)]];return(e,t,n)=>{let r=Math.floor(e),o=Math.floor(t),s=Math.floor(n),c=i(e-r),l=i(t-o),u=i(n-s),d=(e,t,n)=>e+(t-e)*n;return d(d(d(a(r,o,s),a(r+1,o,s),c),d(a(r,o+1,s),a(r+1,o+1,s),c),l),d(d(a(r,o,s+1),a(r+1,o,s+1),c),d(a(r,o+1,s+1),a(r+1,o+1,s+1),c),l),u)}}var eu=1024;function tu(e){let t=Xl(e.seed),n=$l(e.seed^2654435769),r=e.samples,i=e.strands,a=[],o=[],s=[0,0,0];for(let e=0;e<13;e++)Ql(t,s),a.push({dir:[s[0],s[1],s[2]],sigma:.22+t()*.3,weight:.7+t()*.8,swirl:(t()<.5?-1:1)*(.6+t()*1.2)});for(let e=0;e<6;e++)Ql(t,s),o.push({dir:[s[0],s[1],s[2]],sigma:.25+t()*.3,weight:1.2+t()*.6,swirl:0});let c=(e,t,r)=>{let i=.55*n(e*2.2+7,t*2.2,r*2.2)+.25*n(e*5.1,t*5.1+3,r*5.1);for(let n of a){let a=1-(e*n.dir[0]+t*n.dir[1]+r*n.dir[2]);i+=n.weight*Math.exp(-(a*2)/(n.sigma*n.sigma))}for(let n of o){let a=1-(e*n.dir[0]+t*n.dir[1]+r*n.dir[2]);i-=n.weight*Math.exp(-(a*2)/(n.sigma*n.sigma))}return i},l=[];for(let e=0;e<6e3;e++)Ql(t,s),l.push(c(s[0],s[1],s[2]));l.sort((e,t)=>e-t);let u=e=>l[Math.floor(e*(l.length-1))],d=u(.85),f=u(.3),p=u(.1),m=e=>e>=d?0:e>=f?1:e>=p?2:3,h=[0,0,0,0];for(let e of l)h[m(e)]+=1/l.length;let g=e.accept??[1,.34,.1,.012],_=(e,t)=>{t[0]=t[1]=t[2]=0;for(let n of a){let r=e[0]*n.dir[0]+e[1]*n.dir[1]+e[2]*n.dir[2],i=n.weight*Math.exp(-((1-r)*2)/(n.sigma*n.sigma*2.2));t[0]+=i*n.swirl*(n.dir[1]*e[2]-n.dir[2]*e[1]),t[1]+=i*n.swirl*(n.dir[2]*e[0]-n.dir[0]*e[2]),t[2]+=i*n.swirl*(n.dir[0]*e[1]-n.dir[1]*e[0]),t[0]+=i*.8*(n.dir[0]-e[0]*r),t[1]+=i*.8*(n.dir[1]-e[1]*r),t[2]+=i*.8*(n.dir[2]-e[2]*r)}},v=e.mix[0]+e.mix[1]+e.mix[2]+e.mix[3],y=[e.mix[0]/v,(e.mix[0]+e.mix[1])/v,(e.mix[0]+e.mix[1]+e.mix[2])/v],b=new Float32Array(i*r*3),x=new Float32Array(i*r*4),S=new Uint32Array(i*(r-1)*2),C=new Float32Array(i),w=new Float32Array(i),T=Math.ceil(i*r/eu),E=new Float32Array(eu*T*4),D=[0,0,0,0],O=[0,0,0],k=[0,0,0],A=[0,0,0],j=e=>{let t=Math.hypot(e[0],e[1],e[2])||1;e[0]/=t,e[1]/=t,e[2]/=t},ee=(e,t)=>{let n=e[0]*t[0]+e[1]*t[1]+e[2]*t[2];e[0]-=t[0]*n,e[1]-=t[1]*n,e[2]-=t[2]*n},M=e=>{for(let n=0;n<400;n++){Ql(t,O);let n=m(c(O[0],O[1],O[2]));if(!(e&&n!==0)&&t()<g[n])return n}return 1};for(let a=0;a<i;a++){let i=t(),o=i<y[0]?0:i<y[1]?1:i<y[2]?2:3,s=M(o===2);D[s]++;let c=t();C[a]=c,w[a]=o;let l=Math.exp(Zl(t)*.55)*.42*e.brightness;t()<.05&&(l*=3),l*=[1.9,.85,.55,.35][s],l=Math.min(l,3.2);let u=e.shellMin+(e.shellMax-e.shellMin)*t()**.7,d=e.lengthMin+(e.lengthMax-e.lengthMin)*t()**1.6;o===2&&(d*=.45),Ql(t,k),ee(k,O),j(k);let f=d/(r-1),p=o===0?.02:o===1?.22:o===2?.9:.12,m=o===0?.05:o===2?.25:.55,h=.18+t()*.35,g=3+t()*4,v=.012+t()*.02;for(let i=0;i<r;i++){let s=i/(r-1),d=u;o===3?d=u*(1-s*s*(3-2*s)*(1-h)):d+=n(O[0]*g+c*50,O[1]*g,O[2]*g)*v*2;let y=a*r+i;b[y*3]=O[0]*d*e.radius,b[y*3+1]=O[1]*d*e.radius,b[y*3+2]=O[2]*d*e.radius,x[y*4]=c,x[y*4+1]=s,x[y*4+2]=l,x[y*4+3]=o,E[y*4]=b[y*3],E[y*4+1]=b[y*3+1],E[y*4+2]=b[y*3+2],E[y*4+3]=s,_(O,A),ee(A,O),k[0]+=A[0]*m*f*4+(t()-.5)*p,k[1]+=A[1]*m*f*4+(t()-.5)*p,k[2]+=A[2]*m*f*4+(t()-.5)*p,ee(k,O),j(k);let S=o===3?f*.45:f;O[0]+=k[0]*S,O[1]+=k[1]*S,O[2]+=k[2]*S,j(O)}for(let e=0;e<r-1;e++){let t=(a*(r-1)+e)*2;S[t]=a*r+e,S[t+1]=a*r+e+1}}let N=D.reduce((e,t)=>e+t,0)||1;return{strands:i,samples:r,positions:b,data:x,index:S,strandSeed:C,strandKind:w,tex:E,texWidth:eu,texHeight:T,bandFractions:D.map(e=>e/N),surfaceFractions:h}}var nu=20,ru=14,iu=5,au=class{root=new On;outer=new On;inner=new On;uniforms={uTime:{value:0},uDrift:{value:0},uWarp:{value:.05},uBreath:{value:1},uColDeep:{value:new J},uColBase:{value:new J},uColLight:{value:new J},uColHot:{value:new J},uRadius:{value:2},uPulseClock:{value:0},uPulseDensity:{value:.22},uBurst:{value:0},uBurstR:{value:0},uBurstAmt:{value:0},uHover:{value:0},uAudio:{value:0},uPixelScale:{value:600},uPulseReveal:{value:1}};outerData;innerData;outerLines;innerLines;heads;sparks;dust;glyphs;core;halo;coreRings;outerRings;mats=[];posTex;atlas;reveal={rings:{value:1},outer:{value:1},inner:{value:1},core:{value:1},particles:{value:1}};outerIntensity={value:1};innerIntensity={value:.55};coreBreath={value:0};coreBoost={value:1};haloAmt={value:1};sparkClock={value:0};sparkRate={value:.35};coreRingAngles={value:new Jt};outerRingAngles={value:new Jt};outerRingIntensity={value:.5};spinAngle=0;innerAngle=0;axis=new G;q=new jt;burstT=99;densityScale=1;profile;stats={outerStrands:0,innerStrands:0,particles:0,genMs:0};constructor(){let e=performance.now();this.outerData=tu({strands:ll,samples:nu,seed:1337,radius:2,shellMin:.92,shellMax:1.05,lengthMin:.18,lengthMax:1.5,mix:[.26,.42,.17,.15],brightness:1}),this.innerData=tu({strands:ul,samples:ru,seed:4242,radius:2,shellMin:.28,shellMax:.74,lengthMin:.2,lengthMax:1.1,mix:[.3,.45,.15,.1],brightness:.9}),this.stats.genMs=performance.now()-e,this.root.add(this.outer,this.inner),this.outerLines=this.makeFilaments(this.outerData,this.outerIntensity,this.reveal.outer),this.innerLines=this.makeFilaments(this.innerData,this.innerIntensity,this.reveal.inner),this.outer.add(this.outerLines),this.inner.add(this.innerLines),this.posTex=new ri(this.outerData.tex,this.outerData.texWidth,this.outerData.texHeight,A,x),this.posTex.needsUpdate=!0,this.heads=this.makeHeads(),this.outer.add(this.heads),this.atlas=ou(),this.glyphs=this.makeGlyphs(),this.outer.add(this.glyphs),this.sparks=this.makeSparks(),this.dust=this.makeDust(),this.root.add(this.sparks,this.dust),this.halo=this.makeQuad(Hl,Wl,7.2,{uHaloAmt:this.haloAmt,uReveal:this.reveal.outer}),this.halo.renderOrder=-1,this.core=this.makeQuad(Vl,Ul,2.2,{uCoreBreath:this.coreBreath,uCoreBoost:this.coreBoost,uReveal:this.reveal.core}),this.core.renderOrder=2,this.coreRings=this.makeRings([{r:.19,segs:128,gaps:3,ticks:0,b:.9},{r:.25,segs:160,gaps:6,ticks:36,b:.55},{r:.31,segs:160,gaps:2,ticks:0,b:.35}],new Jt(.35,1.2,-.7,0),this.coreRingAngles,{value:1},this.reveal.core),this.outerRings=this.makeRings([{r:1.2,segs:360,gaps:5,ticks:72,b:.5},{r:1.34,segs:360,gaps:9,ticks:0,b:.25},{r:1.13,segs:240,gaps:2,ticks:0,b:.18}],new Jt(1.3,1.42,1.18,0),this.outerRingAngles,this.outerRingIntensity,this.reveal.rings),this.root.add(this.halo,this.coreRings,this.core),this.root.add(this.outerRings)}material(e,t,n){let r=new Ui({vertexShader:e,fragmentShader:t,uniforms:{...this.uniforms,...n},blending:2,transparent:!0,depthWrite:!1,depthTest:!1});return this.mats.push(r),r}makeFilaments(e,t,n){let r=new Ar;r.setAttribute(`position`,new hr(e.positions,3)),r.setAttribute(`aData`,new hr(e.data,4)),r.setIndex(new hr(e.index,1)),r.boundingSphere=new Sr(new G,2.6);let i=new bi(r,this.material(Al,jl,{uIntensity:t,uReveal:n}));return i.frustumCulled=!1,i}makeHeads(){let e=700*iu,t=new Float32Array(e),n=new Float32Array(e*3);for(let e=0;e<700;e++)for(let r=0;r<iu;r++){let i=e*iu+r;t[i]=e,n[i*3]=this.outerData.strandSeed[e],n[i*3+1]=this.outerData.strandKind[e],n[i*3+2]=r}let r=new Ar;r.setAttribute(`position`,new hr(new Float32Array(e*3),3)),r.setAttribute(`aStrand`,new hr(t,1)),r.setAttribute(`aInfo`,new hr(n,3));let i=new Ei(r,this.material(Nl,Pl,{uPosTex:{value:this.posTex},uSamples:{value:nu},uHeadSize:{value:.032},uIntensity:this.outerIntensity}));return i.frustumCulled=!1,i}makeSparks(){let e=Xl(99),t=new Float32Array(1680);for(let n=0;n<t.length;n++)t[n]=e();let n=new Ar;n.setAttribute(`position`,new hr(new Float32Array(1260),3)),n.setAttribute(`aSeed`,new hr(t,4));let r=new Ei(n,this.material(Fl,Il,{uSparkClock:this.sparkClock,uSparkRate:this.sparkRate,uSize:{value:.03},uIntensity:this.outerIntensity,uReveal:this.reveal.particles}));return r.frustumCulled=!1,r}makeDust(){let e=Xl(7),t=new Float32Array(dl*3),n=new Float32Array(dl*4),r=[0,0,0];for(let i=0;i<dl;i++){Ql(e,r);let a=2*(1.05+e()**.55*2.6);t[i*3]=r[0]*a,t[i*3+1]=r[1]*a,t[i*3+2]=r[2]*a,n[i*4]=e(),n[i*4+1]=e(),n[i*4+2]=e(),n[i*4+3]=.3+e()*.7}let i=new Ar;i.setAttribute(`position`,new hr(t,3)),i.setAttribute(`aSeed`,new hr(n,4));let a=new Ei(i,this.material(Ll,Il,{uSize:{value:.022},uIntensity:{value:1},uReveal:this.reveal.particles}));return a.frustumCulled=!1,a}makeGlyphs(){let e=Xl(31),t=new Float32Array(2100),n=new Float32Array(2800),r=[0,0,0];for(let i=0;i<700;i++){Ql(e,r);let a=2*(1.02+e()*.1);t[i*3]=r[0]*a,t[i*3+1]=r[1]*a,t[i*3+2]=r[2]*a,n[i*4]=e(),n[i*4+1]=Math.floor(e()*64),n[i*4+2]=.1+e()*.8,n[i*4+3]=.2+e()**2*.8}let i=new Ar;i.setAttribute(`position`,new hr(t,3)),i.setAttribute(`aSeed`,new hr(n,4));let a=new Ei(i,this.material(Rl,zl,{uAtlas:{value:this.atlas},uSize:{value:.075},uIntensity:{value:1},uReveal:this.reveal.outer}));return a.frustumCulled=!1,a}makeQuad(e,t,n,r){let i=this.material(e,t,{uSize:{value:n},...r}),a=new ei(new Pi(1,1),i);return a.frustumCulled=!1,a}makeRings(e,t,n,r,i){let a=[],o=[],s=Xl(5);e.forEach((e,t)=>{let n=e.r*2,r=Array.from({length:e.gaps},()=>Math.floor(s()*e.segs)),i=Math.floor(e.segs*.04);for(let s=0;s<e.segs;s++){if(r.some(e=>s>=e&&s<e+i))continue;let c=s/e.segs*Math.PI*2,l=(s+1)/e.segs*Math.PI*2;a.push(Math.cos(c)*n,0,Math.sin(c)*n,Math.cos(l)*n,0,Math.sin(l)*n),o.push(t,e.b,t,e.b)}for(let r=0;r<e.ticks;r++){let i=r/e.ticks*Math.PI*2,s=(r%6==0?.05:.022)*2;a.push(Math.cos(i)*n,0,Math.sin(i)*n,Math.cos(i)*(n+s),0,Math.sin(i)*(n+s)),o.push(t,e.b*1.2,t,e.b*1.2)}});let c=new Ar;c.setAttribute(`position`,new vr(a,3)),c.setAttribute(`aRing`,new vr(o,2));let l=new bi(c,this.material(Gl,Kl,{uAngles:n,uTilts:{value:t},uIntensity:r,uReveal:i}));return l.frustumCulled=!1,l}setTheme(e){this.uniforms.uColDeep.value.set(e.deep),this.uniforms.uColBase.value.set(e.base),this.uniforms.uColLight.value.set(e.light),this.uniforms.uColHot.value.set(e.hot)}setQuality(e,t){this.profile=e,this.densityScale=t;let n=Math.min(e.outerStrands,ll),r=Math.min(e.innerStrands,ul);this.outerLines.geometry.setDrawRange(0,n*19*2),this.innerLines.geometry.setDrawRange(0,r*13*2);let i=Math.min(e.pulseHeads,n,700);this.heads.geometry.setDrawRange(0,i*iu);let a=Math.min(420,Math.round(e.sparks*t)),o=Math.min(dl,Math.round(e.dust*t)),s=Math.min(700,Math.round(e.glyphs*t));this.sparks.geometry.setDrawRange(0,a),this.dust.geometry.setDrawRange(0,o),this.glyphs.geometry.setDrawRange(0,s),this.glyphs.visible=s>0,this.stats.outerStrands=n,this.stats.innerStrands=r,this.stats.particles=i*iu+a+o+s}get quality(){return this.profile}get particleDensity(){return this.densityScale}setPixelScale(e,t){this.uniforms.uPixelScale.value=e/(2*Math.tan(At.degToRad(t)/2))}burst(e=1){this.burstT=0,this.burstStrength=e}burstStrength=1;update(e,t,n,r){let i=this.uniforms;i.uTime.value=t,i.uDrift.value+=e*(.045+n.hover*.02+n.audio*.03),i.uWarp.value=.05+n.hover*.012+n.audio*.02;let a=(.5+.5*Math.sin(t*Math.PI*2/3.2))**1.6;i.uBreath.value=1+a*.012+n.audio*.02,this.coreBreath.value=Math.min(1,a*.85+n.hover*.15+n.audio*.5),this.coreBoost.value=1+n.hover*.2+n.audio*.25,this.haloAmt.value=1+n.hover*.35+a*.15,i.uPulseClock.value+=e*n.pulseSpeed*(1+n.audio*.8),i.uPulseDensity.value=Math.min(.9,.2*n.activity+n.audio*.15),i.uHover.value=n.hover,i.uAudio.value=n.audio,this.burstT+=e;let o=this.burstT,s=o<1.6?Math.exp(-o*2.2)*this.burstStrength:0;i.uBurst.value=s,i.uBurstAmt.value=o<1.4?Math.exp(-o*1.8)*this.burstStrength:0,i.uBurstR.value=o*1.1,this.outerIntensity.value=1+n.hover*.18+s*.5,this.innerIntensity.value=.55+n.hover*.12+s*.6,this.sparkClock.value+=e*(1+n.hover*.6+s*3),this.sparkRate.value=Math.min(1,.3+n.hover*.15+s*.6+n.audio*.2);let c=.07*r*n.spin;this.spinAngle+=e*c,this.innerAngle-=e*c*1.55,this.axis.set(Math.sin(t*.021)*.22+.12,1,Math.cos(t*.017)*.18).normalize(),this.q.setFromAxisAngle(this.axis,this.spinAngle),this.outer.quaternion.copy(this.q),this.axis.set(Math.cos(t*.013)*.3,1,Math.sin(t*.019)*.25-.1).normalize(),this.q.setFromAxisAngle(this.axis,this.innerAngle),this.inner.quaternion.copy(this.q);let l=1+n.hover*1.5+s*3,u=this.coreRingAngles.value;u.x+=e*.9*l,u.y-=e*.55*l,u.z+=e*.35*l;let d=this.outerRingAngles.value;d.x+=e*.05*l*r,d.y-=e*.03*l*r,d.z+=e*.08*l*r,this.outerRingIntensity.value=.5+n.hover*.35+s*.5}get drawObjects(){let e=0;return this.root.traverseVisible(t=>{(t.isMesh||t.isLine||t.isPoints)&&e++}),e}dispose(){this.root.traverse(e=>{let t=e.geometry;t&&t.dispose()});for(let e of this.mats)e.dispose();this.posTex.dispose(),this.atlas.dispose()}};function ou(){let e=`3F.A1.0x.FF.7E.::.01.10.C4.9B.>>.E0.5D.2A.B8.6C.{}.D7.11.4E.AF.08.<>.3C.92.7B.EE.1D.//.C0.F4.8A`.split(`.`),t=document.createElement(`canvas`);t.width=t.height=512;let n=t.getContext(`2d`);n.fillStyle=`#000`,n.fillRect(0,0,512,512),n.fillStyle=`#fff`,n.font=`600 26px Consolas, 'Courier New', monospace`,n.textAlign=`center`,n.textBaseline=`middle`;for(let t=0;t<64;t++){let r=t%8*64+32,i=Math.floor(t/8)*64+32;n.fillText(e[t%e.length],r,i)}let r=new ki(t);return r.minFilter=f,r.generateMipmaps=!1,r}var su={IDLE:{hover:0,activity:1,pulseSpeed:1,spin:1,interactive:!1},HOVER:{hover:1,activity:1.8,pulseSpeed:1.35,spin:1.2,interactive:!0},DRAG:{hover:.7,activity:2.2,pulseSpeed:1.5,spin:.25,interactive:!0},APP_RING:{hover:.8,activity:2.4,pulseSpeed:1.4,spin:.6,interactive:!0},LAUNCHING:{hover:1,activity:3.2,pulseSpeed:2.2,spin:.6,interactive:!0},RESET:{hover:.3,activity:1.4,pulseSpeed:1.2,spin:.8,interactive:!0},PAUSED:{hover:0,activity:1,pulseSpeed:1,spin:1,interactive:!1}},cu={IDLE:[`HOVER`,`DRAG`,`APP_RING`,`RESET`,`PAUSED`],HOVER:[`IDLE`,`DRAG`,`APP_RING`,`RESET`,`PAUSED`],DRAG:[`IDLE`,`HOVER`,`APP_RING`,`RESET`,`PAUSED`],APP_RING:[`IDLE`,`HOVER`,`LAUNCHING`,`RESET`,`DRAG`,`PAUSED`],LAUNCHING:[`IDLE`,`HOVER`,`PAUSED`],RESET:[`IDLE`,`HOVER`,`DRAG`,`APP_RING`,`PAUSED`],PAUSED:[`IDLE`]},lu=class{_state=`IDLE`;listeners=[];resumeTo=`IDLE`;get state(){return this._state}go(e){let t=this._state;if(e===t)return!0;if(!cu[t].includes(e))return!1;this._state=e;for(let n of this.listeners)n(e,t);return!0}pause(){this._state!==`PAUSED`&&(this.resumeTo=this._state===`LAUNCHING`||this._state===`RESET`?`IDLE`:this._state===`APP_RING`?`APP_RING`:`IDLE`,this.go(`PAUSED`))}resume(){if(this._state===`PAUSED`){this._state=`IDLE`;for(let e of this.listeners)e(`IDLE`,`PAUSED`);this.resumeTo!==`IDLE`&&this.go(this.resumeTo)}}onChange(e){this.listeners.push(e)}},uu={type:`change`},du={type:`start`},fu={type:`end`},pu=new Vr,mu=new Pr,hu=Math.cos(70*At.DEG2RAD),gu=new G,_u=2*Math.PI,Z={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},vu=1e-6,yu=class extends Ba{constructor(e,t=null){super(e,t),this.state=Z.NONE,this.target=new G,this.cursor=new G,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:`ArrowLeft`,UP:`ArrowUp`,RIGHT:`ArrowRight`,BOTTOM:`ArrowDown`},this.mouseButtons={LEFT:i.ROTATE,MIDDLE:i.DOLLY,RIGHT:i.PAN},this.touches={ONE:a.ROTATE,TWO:a.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle=`auto`,this._domElementKeyEvents=null,this._lastPosition=new G,this._lastQuaternion=new jt,this._lastTargetPosition=new G,this._quat=new jt().setFromUnitVectors(e.up,new G(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new za,this._sphericalDelta=new za,this._scale=1,this._panOffset=new G,this._rotateStart=new W,this._rotateEnd=new W,this._rotateDelta=new W,this._panStart=new W,this._panEnd=new W,this._panDelta=new W,this._dollyStart=new W,this._dollyEnd=new W,this._dollyDelta=new W,this._dollyDirection=new G,this._mouse=new W,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=xu.bind(this),this._onPointerDown=bu.bind(this),this._onPointerUp=Su.bind(this),this._onContextMenu=ku.bind(this),this._onMouseWheel=Tu.bind(this),this._onKeyDown=Eu.bind(this),this._onTouchStart=Du.bind(this),this._onTouchMove=Ou.bind(this),this._onMouseDown=Cu.bind(this),this._onMouseMove=wu.bind(this),this._interceptControlDown=Au.bind(this),this._interceptControlUp=ju.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e===`grab`?this.domElement.style.cursor=`grab`:this.domElement.style.cursor=`auto`}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener(`pointerdown`,this._onPointerDown),this.domElement.addEventListener(`pointercancel`,this._onPointerUp),this.domElement.addEventListener(`contextmenu`,this._onContextMenu),this.domElement.addEventListener(`wheel`,this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener(`keydown`,this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction=`none`}disconnect(){this.state=Z.NONE,this.domElement.removeEventListener(`pointerdown`,this._onPointerDown),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.domElement.removeEventListener(`pointercancel`,this._onPointerUp),this.domElement.removeEventListener(`wheel`,this._onMouseWheel),this.domElement.removeEventListener(`contextmenu`,this._onContextMenu),this.stopListenToKeyEvents();let e=this.domElement.getRootNode();e.removeEventListener(`keydown`,this._interceptControlDown,{capture:!0}),e.removeEventListener(`keyup`,this._interceptControlUp,{capture:!0}),this._controlActive=!1,this._pointers.length=0,this._pointerPositions={},this.domElement.style.touchAction=``,this.domElement.style.cursor=`auto`}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(uu),this.update(),this.state=Z.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){let t=this.object.position;gu.copy(t).sub(this.target),gu.applyQuaternion(this._quat),this._spherical.setFromVector3(gu),this.autoRotate&&this.state===Z.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=_u:n>Math.PI&&(n-=_u),r<-Math.PI?r+=_u:r>Math.PI&&(r-=_u),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let i=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let e=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),i=e!=this._spherical.radius}if(gu.setFromSpherical(this._spherical),gu.applyQuaternion(this._quatInverse),t.copy(this.target).add(gu),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let e=null;if(this.object.isPerspectiveCamera){let t=gu.length();e=this._clampDistance(t*this._scale);let n=t-e;this.object.position.addScaledVector(this._dollyDirection,n),this.object.updateMatrixWorld(),i=!!n}else if(this.object.isOrthographicCamera){let t=new G(this._mouse.x,this._mouse.y,0);t.unproject(this.object);let n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),i=n!==this.object.zoom;let r=new G(this._mouse.x,this._mouse.y,0);r.unproject(this.object),this.object.position.sub(r).add(t),this.object.updateMatrixWorld(),e=gu.length()}else console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled.`),this.zoomToCursor=!1;e!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position):(pu.origin.copy(this.object.position),pu.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(pu.direction))<hu?this.object.lookAt(this.target):(mu.setFromNormalAndCoplanarPoint(this.object.up,this.target),pu.intersectPlane(mu,this.target))))}else if(this.object.isOrthographicCamera){let e=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),e!==this.object.zoom&&(this.object.updateProjectionMatrix(),i=!0)}return this._scale=1,this._performCursorZoom=!1,i||this._lastPosition.distanceToSquared(this.object.position)>vu||8*(1-this._lastQuaternion.dot(this.object.quaternion))>vu||this._lastTargetPosition.distanceToSquared(this.target)>vu?(this.dispatchEvent(uu),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e===null?_u/60/60*this.autoRotateSpeed:_u/60*this.autoRotateSpeed*e}_getZoomScale(e){let t=Math.abs(e*.01);return .95**(this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){gu.setFromMatrixColumn(t,0),gu.multiplyScalar(-e),this._panOffset.add(gu)}_panUp(e,t){this.screenSpacePanning===!0?gu.setFromMatrixColumn(t,1):(gu.setFromMatrixColumn(t,0),gu.crossVectors(this.object.up,gu)),gu.multiplyScalar(e),this._panOffset.add(gu)}_pan(e,t){let n=this.domElement;if(this.object.isPerspectiveCamera){let r=this.object.position;gu.copy(r).sub(this.target);let i=gu.length();i*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*i/n.clientHeight,this.object.matrix),this._panUp(2*t*i/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.`),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),r=e-n.left,i=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(i/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(_u*this._rotateDelta.x/t.clientHeight),this._rotateUp(_u*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(_u*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-_u*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(_u*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-_u*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyStart.set(0,i)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateEnd.set(n,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(_u*this._rotateDelta.x/t.clientHeight),this._rotateUp(_u*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,i),this._dollyDelta.set(0,(this._dollyEnd.y/this._dollyStart.y)**+this.zoomSpeed),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new W,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){let t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){let t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function bu(e){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(e.pointerId),this.domElement.ownerDocument.addEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.addEventListener(`pointerup`,this._onPointerUp)),!this._isTrackingPointer(e)&&(this._addPointer(e),e.pointerType===`touch`?this._onTouchStart(e):this._onMouseDown(e),this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grabbing`)))}function xu(e){this.enabled!==!1&&(e.pointerType===`touch`?this._onTouchMove(e):this._onMouseMove(e))}function Su(e){switch(this._removePointer(e),this._pointers.length){case 0:this.domElement.releasePointerCapture(e.pointerId),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.dispatchEvent(fu),this.state=Z.NONE,this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grab`);break;case 1:let t=this._pointers[0],n=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:n.x,pageY:n.y})}}function Cu(e){let t;switch(e.button){case 0:t=this.mouseButtons.LEFT;break;case 1:t=this.mouseButtons.MIDDLE;break;case 2:t=this.mouseButtons.RIGHT;break;default:t=-1}switch(t){case i.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(e),this.state=Z.DOLLY;break;case i.ROTATE:if(e.ctrlKey||e.metaKey||e.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(e),this.state=Z.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(e),this.state=Z.ROTATE}break;case i.PAN:if(e.ctrlKey||e.metaKey||e.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(e),this.state=Z.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(e),this.state=Z.PAN}break;default:this.state=Z.NONE}this.state!==Z.NONE&&this.dispatchEvent(du)}function wu(e){switch(this.state){case Z.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(e);break;case Z.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(e);break;case Z.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(e)}}function Tu(e){this.enabled!==!1&&this.enableZoom!==!1&&this.state===Z.NONE&&(e.preventDefault(),this.dispatchEvent(du),this._handleMouseWheel(this._customWheelEvent(e)),this.dispatchEvent(fu))}function Eu(e){this.enabled!==!1&&this._handleKeyDown(e)}function Du(e){switch(this._trackPointer(e),this._pointers.length){case 1:switch(this.touches.ONE){case a.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(e),this.state=Z.TOUCH_ROTATE;break;case a.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(e),this.state=Z.TOUCH_PAN;break;default:this.state=Z.NONE}break;case 2:switch(this.touches.TWO){case a.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(e),this.state=Z.TOUCH_DOLLY_PAN;break;case a.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(e),this.state=Z.TOUCH_DOLLY_ROTATE;break;default:this.state=Z.NONE}break;default:this.state=Z.NONE}this.state!==Z.NONE&&this.dispatchEvent(du)}function Ou(e){switch(this._trackPointer(e),this.state){case Z.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(e),this.update();break;case Z.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(e),this.update();break;case Z.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(e),this.update();break;case Z.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(e),this.update();break;default:this.state=Z.NONE}}function ku(e){this.enabled!==!1&&e.preventDefault()}function Au(e){e.key===`Control`&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function ju(e){e.key===`Control`&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}var Mu=6,Nu=400,Pu=260,Fu=3,Iu=class{camera;el;cb;controls;home=new za().setFromVector3(ml);cur=new za;v=new G;center=new G;downX=0;downY=0;downT=0;dragging=!1;pointerDown=!1;over=!1;pendingClick=null;resetting=!1;idleFor=999;lastX=-1;lastY=-1;constructor(e,t,n){this.camera=e,this.el=t,this.cb=n;let r=new yu(e,t);r.enableDamping=!0,r.dampingFactor=.055,r.rotateSpeed=.55,r.enablePan=!1,r.zoomSpeed=.35,r.minDistance=this.home.radius*.78,r.maxDistance=this.home.radius*1.3,r.minPolarAngle=.35,r.maxPolarAngle=Math.PI-.35,r.target.set(0,0,0),r.update(),this.controls=r,t.addEventListener(`pointerdown`,this.onDown),window.addEventListener(`pointermove`,this.onMove,{passive:!0}),window.addEventListener(`pointerup`,this.onUp),t.addEventListener(`wheel`,this.onWheel,{passive:!0}),t.addEventListener(`pointerleave`,this.onLeave),r.addEventListener(`start`,this.onControlStart)}orbScreen(){let e=this.el.clientHeight||window.innerHeight,t=this.el.clientWidth||window.innerWidth;return this.center.set(0,0,0).project(this.camera),{cx:(this.center.x*.5+.5)*t,cy:(-this.center.y*.5+.5)*e,r:2/(this.camera.position.length()*Math.tan(At.degToRad(this.camera.fov)/2))*(e/2)}}isOverOrb(e,t,n=1){let r=this.orbScreen();return Math.hypot(e-r.cx,t-r.cy)<=r.r*n}onControlStart=()=>{this.resetting=!1};onDown=e=>{e.button===0&&(this.pointerDown=!0,this.downX=e.clientX,this.downY=e.clientY,this.downT=performance.now(),this.dragging=!1,this.touch())};onMove=e=>{this.lastX=e.clientX,this.lastY=e.clientY,this.pointerDown&&!this.dragging&&Math.hypot(e.clientX-this.downX,e.clientY-this.downY)>Mu&&(this.dragging=!0,this.cb.onDragStart());let t=this.isOverOrb(e.clientX,e.clientY);t!==this.over&&(this.over=t,this.cb.onHover(t)),(this.pointerDown||t)&&this.touch()};onUp=e=>{if(this.pointerDown){if(this.pointerDown=!1,this.dragging){this.dragging=!1,this.cb.onDragEnd(),this.touch();return}if(!(performance.now()-this.downT>Nu)){if(!this.isOverOrb(e.clientX,e.clientY)){this.cb.onEmptyClick();return}if(this.pendingClick!==null){clearTimeout(this.pendingClick),this.pendingClick=null,this.cb.onDoubleClick();return}this.pendingClick=window.setTimeout(()=>{this.pendingClick=null,this.cb.onOrbClick()},Pu),this.touch()}}};onWheel=()=>this.touch();onLeave=()=>{this.over&&(this.over=!1,this.cb.onHover(!1))};touch(){this.idleFor=0,this.cb.onActivity()}reset(){this.resetting=!0,this.touch()}get isResetting(){return this.resetting}get isDragging(){return this.dragging}get isOver(){return this.over}update(e){this.idleFor+=e;let t=this.resetting||this.idleFor>Fu&&!this.pointerDown,n=!1;if(t){let t=1-Math.exp(-e*(this.resetting?3.2:.55));this.cur.setFromVector3(this.v.copy(this.camera.position).sub(this.controls.target));let r=this.home.theta-this.cur.theta;r=Math.atan2(Math.sin(r),Math.cos(r));let i=this.home.phi-this.cur.phi,a=this.home.radius-this.cur.radius,o=Math.abs(r)+Math.abs(i)+Math.abs(a)*.2;o>1e-4?(this.cur.theta+=r*t,this.cur.phi+=i*t,this.cur.radius+=a*t,this.camera.position.setFromSpherical(this.cur).add(this.controls.target),n=o>.01):this.resetting&&=!1,this.resetting&&o<.01&&(this.resetting=!1)}return n=this.controls.update(e)||n,n}dispose(){this.el.removeEventListener(`pointerdown`,this.onDown),window.removeEventListener(`pointermove`,this.onMove),window.removeEventListener(`pointerup`,this.onUp),this.el.removeEventListener(`wheel`,this.onWheel),this.el.removeEventListener(`pointerleave`,this.onLeave),this.controls.removeEventListener(`start`,this.onControlStart),this.controls.dispose(),this.pendingClick!==null&&clearTimeout(this.pendingClick)}},Lu=.75,Ru=26,zu=2*Math.PI*Ru;function Bu(){let e=`${zu*Lu} ${zu}`;return`<svg viewBox="0 0 64 64" aria-hidden="true">
    <circle class="track" cx="32" cy="32" r="${Ru}" stroke-dasharray="${e}" transform="rotate(135 32 32)"/>
    <circle class="fill" cx="32" cy="32" r="${Ru}" stroke-dasharray="${e}" stroke-dashoffset="${zu*Lu}" transform="rotate(135 32 32)"/>
  </svg>`}function Vu(e){return e>=5&&e<12?`Good morning`:e>=12&&e<17?`Good afternoon`:e>=17&&e<22?`Good evening`:`Good night`}function Hu(e){let t=Math.max(0,e);return t<1e3?`${t.toFixed(0)} B/s`:t<1e6?`${(t/1e3).toFixed(+(t<1e4))} KB/s`:t<1e9?`${(t/1e6).toFixed(+(t<1e7))} MB/s`:`${(t/1e9).toFixed(1)} GB/s`}var Uu=class{el;time;date;greet;stats;link;boot;toast;gauges;clockTimer=null;name=``;toastTimer=null;constructor(e){this.el=e,e.innerHTML=`
      ...
      <section class="hud-stats">
        ${[`cpu`,`ram`,`gpu`,`net`].map(e=>`
          <div class="gauge" data-k="${e}">
            ${Bu()}
            <div class="g-val">--</div>
            <div class="g-label">${e===`net`?`NETWORK`:e.toUpperCase()}</div>
            <div class="g-sub"></div>
          </div>`).join(``)}
    ...
    `;let t=t=>e.querySelector(t);this.time=t(`.hud-time`),this.date=t(`.hud-date`),this.greet=t(`.hud-greet`),this.stats=t(`.hud-stats`),this.link=t(`.hud-link`),this.boot=t(`.hud-boot`),this.toast=t(`.hud-toast`);let n=e=>{let n=t(`.gauge[data-k="${e}"]`);return{root:n,fill:n.querySelector(`.fill`),value:n.querySelector(`.g-val`),sub:n.querySelector(`.g-sub`)}};this.gauges={cpu:n(`cpu`),ram:n(`ram`),gpu:n(`gpu`),net:n(`net`)}}setName(e){this.name=e.trim(),this.renderClock()}setAccent(e,t){this.el.style.setProperty(`--accent`,e),this.el.style.setProperty(`--accent-light`,t)}setStatsVisible(e){this.stats.classList.toggle(`hidden`,!e)}startClock(){if(this.clockTimer!==null)return;let e=()=>{this.renderClock();let t=new Date;this.clockTimer=window.setTimeout(e,1e3-t.getMilliseconds()+5)};e()}stopClock(){this.clockTimer!==null&&(clearTimeout(this.clockTimer),this.clockTimer=null)}renderClock(){let e=new Date,t=`${String(e.getHours()).padStart(2,`0`)}:${String(e.getMinutes()).padStart(2,`0`)}`;this.time.textContent!==t&&(this.time.textContent=t);let n=e.toLocaleDateString(`en-GB`,{weekday:`long`,day:`numeric`,month:`long`}).replace(`,`,``).toUpperCase().replace(/^(\S+)\s/,`$1, `);this.date.textContent!==n&&(this.date.textContent=n);let r=Vu(e.getHours())+(this.name?`, ${this.name}`:``);this.greet.textContent!==r&&(this.greet.textContent=r)}setLink(e){let t=e===`online`?``:e===`unauthorized`?`SYSTEM LINK UNPAIRED`:e===`disabled`?``:e===`connecting`?`LINKING…`:`STATS OFFLINE`;this.link.textContent=t,this.link.classList.toggle(`show`,t!==``),this.stats.classList.toggle(`offline`,e!==`online`)}setGauge(e,t,n,r=``){let i=Math.max(0,Math.min(1,t));e.fill.style.strokeDashoffset=String(zu*Lu*(1-i)),e.value.textContent!==n&&(e.value.textContent=n),e.sub.textContent!==r&&(e.sub.textContent=r)}setStats(e){this.setGauge(this.gauges.cpu,e.cpu/100,`${Math.round(e.cpu)}%`),this.setGauge(this.gauges.ram,e.ram/100,`${Math.round(e.ram)}%`),e.gpu===null?this.setGauge(this.gauges.gpu,0,`—`,`n/a`):this.setGauge(this.gauges.gpu,e.gpu/100,`${Math.round(e.gpu)}%`);let t=e.network.down+e.network.up,n=t<=1e3?0:Math.log10(t/1e3)/6;this.setGauge(this.gauges.net,n,Hu(e.network.down),`↑ ${Hu(e.network.up)}`)}bootText(e,t,n){let r=t.slice(0,e);this.boot.textContent!==r&&(this.boot.textContent=r),this.boot.style.opacity=String(n)}showToast(e,t=2600){this.toast.textContent=e,this.toast.classList.add(`show`),this.toastTimer!==null&&clearTimeout(this.toastTimer),this.toastTimer=window.setTimeout(()=>this.toast.classList.remove(`show`),t)}},Wu=class{el;enabled=!1;acc=0;constructor(e){this.el=document.createElement(`pre`),this.el.className=`debug`,this.parent=e}parent;get isEnabled(){return this.enabled}setEnabled(e){this.enabled=e,e?this.parent.appendChild(this.el):this.el.remove()}tick(e){return this.enabled?(this.acc+=e,this.acc>=.5):!1}render(e){if(!this.enabled)return;this.acc=0;let t=performance.memory,n=(e,t=1)=>Number.isFinite(e)?e.toFixed(t):`n/a`;this.el.textContent=[`VISION DEBUG`,`state        ${e.state}`,`fps          ${n(e.fps)} (target ${e.targetFps})`,`frame (cpu)  ${n(e.frameMs,2)} ms`,`frame (gpu)  ${Number.isNaN(e.gpuMs)?`no timer ext`:n(e.gpuMs,2)+` ms`}`,`draw calls   ${e.totalCalls} total · ${e.sceneCalls} orb`,`primitives   ${e.lines} lines · ${e.points} points · ${e.triangles} tris`,`dpr          ${n(e.dpr,2)}`,`filaments    ${e.outerStrands} outer · ${e.innerStrands} inner`,`particles    ${e.particles}`,`renderer     ${e.renderer}`,`quality      ${e.quality} · auto step ${e.autoStep}`,`auto         ${e.autoReason}`,`helper       ${e.helper}`,`js heap      ${t?`${(t.usedJSHeapSize/1048576).toFixed(1)} / ${(t.totalJSHeapSize/1048576).toFixed(1)} MB`:`n/a`}`,`gen          ${n(e.genMs,0)} ms`].join(`
`)}},Gu=/^[a-z0-9][a-z0-9_-]{0,31}$/,Ku=1500,qu=1200,Ju=15e3,Yu=class{cfg;status=`connecting`;lastStats=null;timer=null;backoff=Ku;running=!1;pollStats=!0;inflight=null;statusListeners=[];statsListeners=[];constructor(e){this.cfg=e}configure(e){let t=e.port!==void 0&&e.port!==this.cfg.port||e.token!==void 0&&e.token!==this.cfg.token;this.cfg={...this.cfg,...e},t&&this.running&&(this.backoff=Ku,this.schedule(0))}get hasToken(){return this.cfg.token.length>0}onStatus(e){this.statusListeners.push(e)}onStats(e){this.statsListeners.push(e)}setStatus(e){if(e!==this.status){this.status=e;for(let t of this.statusListeners)t(e)}}setStatsEnabled(e){this.pollStats=e,e?this.running&&(this.setStatus(`connecting`),this.schedule(0)):(this.clear(),this.setStatus(`disabled`))}start(){this.running||(this.running=!0,this.pollStats&&this.schedule(0))}stop(){this.running=!1,this.clear()}clear(){this.timer!==null&&(clearTimeout(this.timer),this.timer=null),this.inflight?.abort(),this.inflight=null}schedule(e){this.timer!==null&&clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this.timer=null,this.tick()},e)}url(e){return`http://127.0.0.1:${this.cfg.port}${e}`}async request(e,t={}){let n=new AbortController;this.inflight=n;let r=window.setTimeout(()=>n.abort(),qu);try{return await fetch(this.url(e),{...t,signal:n.signal,cache:`no-store`,headers:{"X-Vision-Token":this.cfg.token,...t.headers??{}}})}finally{clearTimeout(r),this.inflight===n&&(this.inflight=null)}}async tick(){if(this.running&&this.pollStats){if(!this.hasToken){this.setStatus(`unauthorized`),this.schedule(Ju);return}try{let e=await this.request(`/stats`);if(e.status===401||e.status===403)this.setStatus(`unauthorized`),this.backoff=Ju;else if(e.ok){let t=Zu(await e.json());if(!t)throw Error(`bad payload`);this.lastStats=t,this.backoff=Ku,this.setStatus(`online`);for(let e of this.statsListeners)e(t)}else throw Error(`HTTP ${e.status}`)}catch{if(!this.running)return;this.setStatus(`offline`),this.backoff=Math.min(Ju,Math.max(Ku,this.backoff*1.6))}this.running&&this.pollStats&&this.schedule(this.backoff)}}async apps(){if(!this.hasToken)return null;try{let e=await this.request(`/apps`);if(!e.ok)return null;let t=await e.json();return Array.isArray(t.apps)?t.apps.filter(e=>!!e&&typeof e.id==`string`&&Gu.test(e.id)).slice(0,12).map(e=>({id:e.id,label:String(e.label??e.id).slice(0,24),icon:typeof e.icon==`string`&&/^data:image\/(png|x-icon|vnd\.microsoft\.icon|svg\+xml|jpeg|webp);base64,/.test(e.icon)?e.icon:null})):null}catch{return null}}async launch(e){if(!Gu.test(e))return{ok:!1,code:`invalid_id`};try{let t=await this.request(`/launch/${encodeURIComponent(e)}`,{method:`POST`}),n=t.ok?`launched`:`http_${t.status}`;try{let e=await t.json();e.code&&(n=String(e.code))}catch{}return{ok:t.ok,code:n}}catch{return this.setStatus(`offline`),{ok:!1,code:`offline`}}}};function Xu(e){return typeof e==`number`&&Number.isFinite(e)?e:null}function Zu(e){if(!e||typeof e!=`object`)return null;let t=e,n=Xu(t.cpu),r=Xu(t.ram);if(n===null||r===null)return null;let i=t.network??{},a=e=>Math.max(0,Math.min(100,e)),o=Xu(t.gpu);return{cpu:a(n),ram:a(r),gpu:o===null?null:a(o),network:{up:Math.max(0,Xu(i.up)??0),down:Math.max(0,Xu(i.down)??0)},time:typeof t.time==`string`?t.time:``}}var Qu=3.24,$u=.38,ed=-.12,td=56,nd=`vision.apps.v1`,rd=`
...
`;function ad(e){let t=(e.trim()[0]??`?`).toUpperCase(),n=document.createElement(`span`);return n.className=`mono`,n.textContent=t,n}var od=class{orb;camera;helper;cb;group=new On;ringMat;beamMat;ringLine;beam;layer;nodes=[];phase=`closed`;t=0;spin=0;selected=null;launched=!1;apps=[];appsFetchedAt=0;v=new G;c=new G;rot=new $t;constructor(e,t,n,r,i){this.orb=e,this.camera=t,this.helper=r,this.cb=i,this.layer=document.createElement(`div`),this.layer.className=`app-layer`,n.appendChild(this.layer),this.group.rotation.set($u,0,ed),this.rot.makeRotationFromEuler(this.group.rotation);let a=[],o=[];for(let[e,t]of[[1,.9],[1.04,.3]])for(let n=0;n<180;n++){let r=n/180*Math.PI*2,i=(n+1)/180*Math.PI*2;a.push(Math.cos(r)*Qu*e,0,Math.sin(r)*Qu*e,Math.cos(i)*Qu*e,0,Math.sin(i)*Qu*e),o.push(t,t)}for(let e=0;e<48;e++){let t=e/48*Math.PI*2;a.push(Math.cos(t)*Qu*.97,0,Math.sin(t)*Qu*.97,Math.cos(t)*Qu,0,Math.sin(t)*Qu),o.push(.5,.5)}let s=new Ar;s.setAttribute(`position`,new vr(a,3)),s.setAttribute(`aB`,new vr(o,1));let c={blending:2,transparent:!0,depthWrite:!1,depthTest:!1};this.ringMat=new Ui({vertexShader:rd,fragmentShader:Kl.replace(`varying float vI;`,`varying float vA;`).replace(`palette(vHeat) * vI`,`palette(vHeat) * vA`),uniforms:{...e.uniforms,uScale:{value:0},uOpacity:{value:0},uRingR:{value:Qu}},...c}),this.ringLine=new bi(s,this.ringMat),this.ringLine.frustumCulled=!1,this.group.add(this.ringLine);let l=new Ar;l.setAttribute(`position`,new hr(new Float32Array(168),3)),l.setAttribute(`aT`,new hr(Float32Array.from({length:td},(e,t)=>t/55),1)),this.beamMat=new Ui({vertexShader:id,fragmentShader:Il,uniforms:{...e.uniforms,uFrom:{value:new G},uBeamT:{value:0}},...c}),this.beam=new Ei(l,this.beamMat),this.beam.frustumCulled=!1,this.beam.visible=!1,this.group.visible=!1;try{let e=localStorage.getItem(nd);e&&(this.apps=JSON.parse(e))}catch{}}get beamObject(){return this.beam}get isOpen(){return this.phase!==`closed`}get isAnimating(){return this.phase!==`closed`}get currentPhase(){return this.phase}open(){this.phase!==`open`&&this.phase!==`opening`&&(this.phase=`opening`,this.t=0,this.launched=!1,this.selected=null,this.group.visible=!0,this.orb.burst(.35),this.buildNodes(this.apps),(performance.now()-this.appsFetchedAt>3e4||this.apps.length===0)&&this.refreshApps())}close(){this.phase!==`closed`&&this.phase!==`closing`&&(this.phase=`closing`,this.t=0)}async refreshApps(){let e=await this.helper.apps();if(e===null){this.apps.length===0&&this.isOpen&&this.buildNodes([]);return}this.appsFetchedAt=performance.now();let t=JSON.stringify(e)!==JSON.stringify(this.apps);this.apps=e;try{localStorage.setItem(nd,JSON.stringify(e.map(e=>({...e,icon:e.icon&&e.icon.length<4e4?e.icon:null}))))}catch{}t&&(this.phase===`opening`||this.phase===`open`)&&this.buildNodes(e)}buildNodes(e){this.layer.replaceChildren();let t=e.length?e:[{id:``,label:this.helper.status===`online`?`NO APPS`:`LINK OFFLINE`,icon:null}];this.nodes=t.map((e,n)=>{let r=document.createElement(`button`);r.type=`button`,r.className=`app-node`+(e.id?``:` disabled`),r.setAttribute(`aria-label`,e.label);let i=document.createElement(`div`);if(i.className=`app-icon`,e.icon){let t=document.createElement(`img`);t.src=e.icon,t.alt=``,t.draggable=!1,i.appendChild(t)}else i.appendChild(ad(e.label));let a=document.createElement(`div`);a.className=`app-label`,a.textContent=e.label,r.append(i,a);let o={app:e,el:r,angle0:n/t.length*Math.PI*2+Math.PI/2,emerge:0,collapse:0};return r.addEventListener(`click`,e=>{e.stopPropagation(),this.select(o)}),r.addEventListener(`pointerdown`,e=>e.stopPropagation()),this.layer.appendChild(r),o})}select(e){if(this.phase===`open`||this.phase===`opening`){if(!e.app.id){this.cb.onToast(this.helper.status===`online`?`ADD APPS IN helper/apps.json`:`SYSTEM LINK OFFLINE`);return}this.selected=e,this.phase=`launching`,this.t=0,e.el.classList.add(`selected`),this.nodeWorld(e,this.beamMat.uniforms.uFrom.value),this.beam.visible=!0,this.cb.onLaunchStart()}}nodeWorld(e,t){let n=e.angle0+this.spin,r=.25+.75*e.emerge;return t.set(Math.cos(n)*Qu*r,0,Math.sin(n)*Qu*r).applyMatrix4(this.rot),t}update(e){if(this.phase===`closed`)return;this.t+=e;let t=this.t,n=e=>1-(1-Math.min(1,Math.max(0,e)))**3,r=e=>(e=Math.min(1,Math.max(0,e)),1+2.5*(e-1)**3+1.5*(e-1)**2),i=1;if(this.phase===`opening`)i=n(t/.4),this.nodes.forEach((e,n)=>{e.emerge=r((t-.18-n*.05)/.45)}),t>.7+this.nodes.length*.05&&(this.phase=`open`),this.spin+=e*(.07+1.1*Math.exp(-t*3));else if(this.phase===`open`){this.spin+=e*.07;for(let e of this.nodes)e.emerge=1}else if(this.phase===`launching`){if(this.spin+=e*.015,this.beamMat.uniforms.uBeamT.value=t/.42,!this.launched&&t>=.4){this.launched=!0,this.orb.burst(1);let e=this.selected.app.id;this.helper.launch(e).then(e=>{e.ok||this.cb.onToast(e.code===`offline`?`SYSTEM LINK OFFLINE`:`LAUNCH FAILED · ${e.code.toUpperCase()}`)})}this.selected&&(this.selected.collapse=n((t-.45)/.35)),t>.85&&(this.beam.visible=!1,this.phase=`closing`,this.t=0)}else if(this.phase===`closing`&&(i=1-n(t/.35),this.nodes.forEach(e=>{e.emerge=Math.min(e.emerge,i)}),this.spin+=e*.05,t>=.35)){this.phase=`closed`,this.group.visible=!1,this.beam.visible=!1,this.layer.replaceChildren(),this.nodes=[],this.cb.onClosed();return}this.ringMat.uniforms.uScale.value=.3+.7*i,this.ringMat.uniforms.uOpacity.value=i*.55,this.layoutNodes()}layoutNodes(){let e=window.innerWidth,t=window.innerHeight;this.c.set(0,0,0).applyMatrix4(this.camera.matrixWorldInverse);for(let n of this.nodes){this.nodeWorld(n,this.v);let r=this.v.applyMatrix4(this.camera.matrixWorldInverse),i=Math.max(-1,Math.min(1,(r.z-this.c.z)/Qu));r.applyMatrix4(this.camera.projectionMatrix);let a=(r.x*.5+.5)*e,o=(-r.y*.5+.5)*t,s=n.emerge*(1-n.collapse),c=(.78+.3*(i*.5+.5))*(.4+.6*s)*(1-n.collapse*.8),l=s*(.45+.55*(i*.5+.5));n.el.style.transform=`translate3d(${a.toFixed(1)}px, ${o.toFixed(1)}px, 0) translate(-50%, -50%) scale(${c.toFixed(3)})`,n.el.style.opacity=l.toFixed(3),n.el.style.zIndex=String(Math.round(100+i*50)),n.el.style.pointerEvents=s>.6&&i>-.85?`auto`:`none`}}dispose(){this.ringLine.geometry.dispose(),this.beam.geometry.dispose(),this.ringMat.dispose(),this.beamMat.dispose(),this.layer.remove()}};function sd(e,t){let n={...e},r=1;return t>=1&&(r=.6),t>=2&&(n.outerStrands=Math.max(1500,Math.round(n.outerStrands*.75)),n.innerStrands=Math.round(n.innerStrands*.75),n.pulseHeads=Math.round(n.pulseHeads*.75)),t>=3&&(n.bloomScale*=.6),t>=4&&(n.dprCap=Math.min(n.dprCap,1)),t>=5&&(n.chromatic=!1,n.glyphs=0),{profile:n,particleScale:r}}var cd=3.3,ld=4,ud=class{apply;step=0;lastReason=`not measured`;sampling=!1;sampleT=0;intervals=[];cooldown=0;recheck=0;constructor(e){this.apply=e}begin(e=0){this.sampling=!0,this.sampleT=-e,this.intervals.length=0}get isSampling(){return this.sampling&&this.sampleT>=0}reset(){this.step=0,this.lastReason=`reset`,this.cooldown=0}frame(e,t,n,r,i,a){if(!a)return;if(!this.sampling){this.recheck+=e,this.recheck>30&&(this.recheck=0,this.begin());return}if(this.sampleT+=e,this.sampleT<0||(this.intervals.length<600&&this.intervals.push(t),this.sampleT<ld))return;if(this.sampling=!1,this.recheck=0,this.cooldown>0){this.cooldown--;return}let o=[...this.intervals].sort((e,t)=>e-t),s=o[Math.floor(o.length/2)]??0,c=1e3/n,l=!1,u;if(Number.isNaN(r))l=s>c*1.25+2,u=`pacing median ${s.toFixed(1)} ms vs ${c.toFixed(1)} ms target`;else{let e=r*30/10;l=r>cd,u=`gpu ${r.toFixed(2)} ms/frame (≈${e.toFixed(1)}% @30fps)`}if(this.lastReason=u+(l?` → over budget`:` → ok`),l&&this.step<5){this.step++;let{profile:e,particleScale:t}=sd(i,this.step);this.apply({step:this.step,profile:e,particleScale:t,reason:this.lastReason}),this.cooldown=0,this.begin(1)}}},dd=class{gl;ext;pending=[];active=null;free=[];ms=NaN;samples=0;enabled=!1;constructor(e){this.gl=e,this.ext=e.getExtension(`EXT_disjoint_timer_query_webgl2`)??null}get available(){return this.ext!==null}begin(){if(!this.enabled||!this.ext||this.active||this.pending.length>4)return;let e=this.free.pop()??this.gl.createQuery();e&&(this.gl.beginQuery(this.ext.TIME_ELAPSED_EXT,e),this.active=e)}end(){this.ext&&this.active&&(this.gl.endQuery(this.ext.TIME_ELAPSED_EXT),this.pending.push(this.active),this.active=null,this.poll())}poll(){let e=this.gl,t=this.ext?e.getParameter(this.ext.GPU_DISJOINT_EXT):!1;for(;this.pending.length;){let n=this.pending[0];if(!e.getQueryParameter(n,e.QUERY_RESULT_AVAILABLE))break;this.pending.shift();let r=e.getQueryParameter(n,e.QUERY_RESULT);if(this.free.push(n),t)continue;let i=r/1e6;this.ms=Number.isNaN(this.ms)?i:this.ms*.9+i*.1,this.samples++}}reset(){this.ms=NaN,this.samples=0}onContextRestored(){this.ext=this.gl.getExtension(`EXT_disjoint_timer_query_webgl2`)??null,this.pending=[],this.free=[],this.active=null,this.reset()}};r.install();var fd=new URLSearchParams(location.search),pd=fd.has(`t`)?Number(fd.get(`t`)):null,md=fd.get(`demo`),hd=fd.has(`boot`)?Number(fd.get(`boot`)):null,gd=fd.get(`capture`)===`1`,Q={...pl},_d=window.VISION_HELPER;_d?.port&&(Q.helperPort=_d.port),fd.get(`theme`)&&(Q.theme=fd.get(`theme`)),fd.get(`q`)&&(Q.quality=fd.get(`q`)),fd.get(`auto`)===`0`&&(Q.autoQuality=!1),fd.get(`debug`)===`1`&&(Q.debugOverlay=!0),fd.get(`name`)&&(Q.userName=fd.get(`name`));var vd=document.getElementById(`stage`),yd=document.getElementById(`hud`),$=new Yl(vd,cf,lf),bd=new au;$.scene.add(bd.root);var xd=new dd($.renderer.getContext()),Sd=new lu,Cd=new Uu(yd),wd=new Wu(document.body),Td=new Yu({port:Q.helperPort,token:_d?.token??``}),Ed=new od(bd,$.camera,yd,Td,{onClosed:()=>{Sd.go(Od.isOver?`HOVER`:`IDLE`)},onLaunchStart:()=>{Sd.go(`LAUNCHING`)},onToast:e=>Cd.showToast(e)});$.scene.add(Ed.group,Ed.beamObject);var Dd=new ud(e=>{jd(e.profile,e.particleScale)}),Od=new Iu($.camera,$.canvas,{onHover(e){e&&Sd.state===`IDLE`?Sd.go(`HOVER`):!e&&Sd.state===`HOVER`&&Sd.go(`IDLE`),Yd()},onDragStart(){(Sd.state===`IDLE`||Sd.state===`HOVER`||Sd.state===`RESET`)&&Sd.go(`DRAG`),Yd()},onDragEnd(){Sd.state===`DRAG`&&Sd.go(Od.isOver?`HOVER`:`IDLE`)},onOrbClick(){if(Sd.state!==`LAUNCHING`){if(Ed.isOpen){Ed.close();return}Sd.go(`APP_RING`)&&Ed.open(),Yd()}},onEmptyClick(){Ed.isOpen&&Sd.state!==`LAUNCHING`&&Ed.close()},onDoubleClick(){Sd.state!==`LAUNCHING`&&(Ed.isOpen&&Ed.close(),Od.reset(),Sd.go(`RESET`),Yd())},onActivity:()=>Yd()});function kd(){return Q.theme===`custom`?cl(Q.customColor):sl[Q.theme]??sl.gold}function Ad(){let e=kd();bd.setTheme(e),$.setBackground(e.bg),document.body.style.background=e.bg,Cd.setAccent(e.base,e.light)}function jd(e=fl[Q.quality]??fl.medium,t=1){bd.setQuality(e,Q.particleDensity*t),$.setDprCap(e.dprCap),$.setBloom(.85*Q.bloomStrength,e.bloomScale),$.setChromatic(e.chromatic),bd.setPixelScale($.bufferHeight,$.camera.fov),Yd()}function Md(e){(!e||e.theme!==Q.theme||e.customColor!==Q.customColor)&&Ad();let t=!e||e.quality!==Q.quality||e.autoQuality!==Q.autoQuality;if(t&&(Dd.reset(),Q.autoQuality&&Dd.begin(2.5)),t||!e||e.particleDensity!==Q.particleDensity||e.bloomStrength!==Q.bloomStrength){let e=fl[Q.quality]??fl.medium,{profile:t,particleScale:n}=Q.autoQuality?sd(e,Dd.step):{profile:e,particleScale:1};jd(t,n)}if(Cd.setName(Q.userName),Cd.setStatsVisible(Q.hudStats),Td.setStatsEnabled(Q.hudStats),Td.configure({port:Q.helperPort,token:Q.helperToken||_d?.token||``}),wd.setEnabled(Q.debugOverlay),Q.audioReactive&&(!e||!e.audioReactive)){let e=Pd;window.setTimeout(()=>{Q.audioReactive&&Pd===e&&Cd.showToast(`AUDIO FEED OFF · RUN tools\\windows\\enable-audio.ps1`,5e3)},4e3)}xd.enabled=Q.debugOverlay||Q.autoQuality,Q.audioReactive||(Nd=0)}r.onProperties(e=>{let t={...Q};Object.assign(Q,e),Md(t)});var Nd=0,Pd=0;r.onAudio(e=>{if(Pd++,!Q.audioReactive||Ld)return;let t=0,n=Math.min(24,e.length);for(let r=0;r<n;r++)t+=e[r]||0;let r=Math.min(1,t/Math.max(1,n)*1.6);Nd=r>Nd?Nd+(r-Nd)*.5:Nd*.92}),Td.onStatus(e=>Cd.setLink(e)),Td.onStats(e=>Cd.setStats(e)),Cd.setLink(Td.status);var Fd=0,Id=!1,Ld=!1,Rd=0,zd=0,Bd=0,Vd=0,Hd=60,Ud=0,Wd=0,Gd=0,Kd=0,qd=2.6,Jd={hover:0,activity:1,pulseSpeed:1,spin:1,audio:0};function Yd(){Id&&!Ld&&Hd!==60&&(Hd=60,zd=performance.now())}function Xd(e){return Vd<qd||su[Sd.state].interactive||Ed.isAnimating||e||Od.idleFor<3?60:30}function Zd(){Id||Ld||$.contextLost||gd||(Id=!0,Rd=performance.now(),zd=Rd,Fd=requestAnimationFrame(ef))}function Qd(){Id=!1,cancelAnimationFrame(Fd)}var $d=e=>(e=Math.min(1,Math.max(0,e)),e*e*(3-2*e));function ef(e){if(!Id)return;Fd=requestAnimationFrame(ef);let t=1e3/Hd;if(e<zd-3)return;zd+=t,e-zd>t&&(zd=e+t);let n=e-Rd;Rd=e,tf(Math.min(.1,n/1e3),n)}function tf(e,t){let n=performance.now();Bd+=e,Vd=hd??Vd+e,rf();let r=su[Sd.state],i=1-Math.exp(-e*4);Jd.hover+=(r.hover-Jd.hover)*i,Jd.activity+=(r.activity-Jd.activity)*i,Jd.pulseSpeed+=(r.pulseSpeed-Jd.pulseSpeed)*i,Jd.spin+=(r.spin-Jd.spin)*(1-Math.exp(-e*1.2)),Jd.audio=Q.audioReactive?Nd*.8:0;let a=Od.update(e);if(Sd.state===`RESET`&&!Od.isResetting&&Sd.go(Od.isOver?`HOVER`:`IDLE`),Ed.update(e),bd.update(e,pd??Bd,Jd,Q.rotationSpeed),xd.begin(),$.render(Bd),xd.end(),Kd=Kd*.9+(performance.now()-n)*.1,Ud+=e,Wd++,Ud>=1&&(Gd=Wd/Ud,Ud=0,Wd=0),Vd>qd){let n=fl[Q.quality]??fl.medium;Dd.frame(e,t,Hd,xd.ms,n,Q.autoQuality)}wd.tick(e)&&($.sampleSceneStats(),wd.render({fps:Gd,frameMs:Kd,gpuMs:xd.ms,targetFps:Hd,totalCalls:$.lastTotalCalls,sceneCalls:$.lastSceneCalls,lines:$.lastSceneLines,points:$.lastScenePoints,triangles:$.lastSceneTriangles,dpr:$.dpr,outerStrands:bd.stats.outerStrands,innerStrands:bd.stats.innerStrands,particles:bd.stats.particles,renderer:`${$.isWebGL2?`WebGL2`:`WebGL1`} · ${$.gpuName.slice(0,60)}`,quality:Q.quality+(Q.autoQuality?` (auto)`:``),autoStep:Dd.step,autoReason:Dd.lastReason,helper:Td.status,state:Sd.state,genMs:bd.stats.genMs})),Hd=Xd(a),df.frames++}var nf=!1;function rf(){if(Vd>2.7&&hd===null)return;let e=pd!==null&&hd===null?99:Vd;bd.reveal.rings.value=$d((e-.2)/.5),bd.reveal.outer.value=$d((e-.3)/.7),bd.reveal.inner.value=$d((e-.5)/.6),bd.reveal.core.value=$d((e-.8)/.35)*(1+.8*Math.exp(-Math.max(0,e-.95)*5)*(e>.8)),bd.uniforms.uPulseReveal.value=$d((e-1.1)/.4),bd.reveal.particles.value=$d((e-.9)/.8),!nf&&e>=1.1&&(nf=!0,bd.burst(.45));let t=Math.max(0,Math.min(13,Math.floor((e-1.3)/.045))),n=e<2?1:1-$d((e-2)/.55);Cd.bootText(t,`VISION ONLINE`,n)}var af=!1;function of(e){e!==Ld&&(Ld=e,Ld?(Qd(),Td.stop(),Cd.stopClock(),Sd.pause()):(Sd.resume(),Cd.startClock(),Td.start(),Hd=60,Zd()))}function sf(){of(document.visibilityState===`hidden`||af)}document.addEventListener(`visibilitychange`,sf),r.onPause(e=>{af=e,sf()});function cf(){Qd(),xd.enabled=!1,df.contextLosses++}function lf(){xd.onContextRestored(),xd.enabled=Q.debugOverlay||Q.autoQuality,bd.setPixelScale($.bufferHeight,$.camera.fov),df.contextRestores++,Ld||Zd()}var uf=null;window.addEventListener(`resize`,()=>{uf!==null&&clearTimeout(uf),uf=window.setTimeout(()=>{uf=null,$.resize(),bd.setPixelScale($.bufferHeight,$.camera.fov),Yd()},120)});var df={frames:0,contextLosses:0,contextRestores:0};$.resize(),Md(),Cd.startClock(),Td.start(),Q.autoQuality&&Dd.begin(0),Sd.onChange(e=>{e!==`IDLE`&&e!==`PAUSED`&&Yd()}),sf(),Zd(),md===`hover`&&setTimeout(()=>{Sd.go(`HOVER`)},50),(md===`ring`||md===`launch`)&&setTimeout(()=>{Sd.go(`APP_RING`)&&Ed.open()},50),md===`drag`&&setTimeout(()=>{Sd.go(`DRAG`),$.camera.position.set(4.2,2.6,5.2)},50),window.__vision={orb:bd,core:$,sm:Sd,ring:Ed,helper:Td,input:Od,settings:Q,perf:df,auto:Dd,gpuTimer:xd,get targetFps(){return Hd},get running(){return Id},captureStep(e=1){for(let t=0;t<e;t++)tf(1/30,1e3/30)},get fps(){return Gd},home:ml}})();